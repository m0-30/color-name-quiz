// 🎨 全カラー（完全版）
const colors = [
{name:"カーマイン",color:"#960018",hint:"西洋の真紅",ex:"コチニール由来の動物染料の赤"},
{name:"茜色",color:"#b7282e",hint:"アカネの根",ex:"夕日の色を表す色名としても使われる"},
{name:"ワインレッド",color:"#722f37",hint:"ワイン",ex:"赤ワインのような濃く深い紫みの赤"},
{name:"牡丹色",color:"#e7609e",hint:"室町時代にかけて栽培された",ex:"牡丹の花のような鮮やかな赤紫"},
{name:"桜色",color:"#ffd1dc",hint:"紅染めの中で最も淡いピンク",ex:"桜の花のようなごく薄い紫みを帯びた赤"},
{name:"珊瑚色",color:"#ff7f7f",hint:"洋の東西を問わず珍重されたピンク系の色",ex:"珊瑚のような明るい黄みを帯びた赤"},
{name:"ピーチ",color:"#ffdab9",hint:"とある果実の色",ex:"桃の果肉の色を表す明るく淡いオレンジ色"},
{name:"ベージュ",color:"#eedcb3",hint:"未加工・未染料の毛織物の色を表す色。",ex:"明るい灰みの赤みを帯びた黄"},
{name:"煉瓦色",color:"#b55239",hint:"深い赤系の建物に使われる色",ex:"赤レンガのようなくすんだ赤褐色"},
{name:"スカーレット",color:"#ff2400",hint:"和色名「緋色」",ex:"炎のような鮮やかな黄みの赤"},
{name:"朱色",color:"#ef454a",hint:"銀朱を原料とする鉱物顔料の色",ex:"印鑑の朱肉のような鮮やかな黄みの赤"},
{name:"ボルドー",color:"#6c2735",hint:"フランス産の赤ワインのような色",ex:"赤ワインのような暗い赤紫系の色"},
{name:"ローズピンク",color:"#ff66cc",hint:"ピンク色のバラに由来する落ち着いた気品のある色",ex:"バラの色の中でも明るい紫みを帯びた赤"},
{name:"鴇色",color:"#f4b3c2",hint:"江戸時代に流行した明るく優しいピンク",ex:"薄い紫みを帯びた赤"},
{name:"サーモンピンク",color:"#fa8072",hint:"魚の身の色からとられた",ex:"鮭の身のようなやわらかい黄みの赤"},
{name:"テラコッタ",color:"#e2725b",hint:"イタリア語で「焼いた土」",ex:"粘土で作った素焼きの土器・装飾品の色"},

{name:"ココア",color:"#6f4e37",hint:"カカオ豆から作られる飲み物",ex:"ココアのような赤みがある茶色"},
{name:"コーヒーブラウン",color:"#4b3621",hint:"茶色の中でも黄みがかっていることが特徴",ex:"炒ったコーヒー豆のような黄みを帯びた茶色"},
{name:"黄丹",color:"#ee7948",hint:"皇太子の礼服の色",ex:"紅花とくちなしで染めたオレンジ"},
{name:"山吹色",color:"#f8b500",hint:"黄色の花から名づけられた",ex:"ヤマブキのような鮮やかな黄色"},
{name:"鬱金色",color:"#e1ad21",hint:"カレー粉やたくあん漬けの着色料としても用いられる",ex:"ウコンの根で染めた赤みの黄色"},
{name:"キャメル",color:"#c19a6b",hint:"ラクダの毛皮の色からとられた",ex:"黄みが強く、あまり暗くない茶色"},
{name:"チョコレート",color:"#3f2a1d",hint:"カカオ豆で作られたお菓子",ex:"赤みを帯びた暗い茶色"},
{name:"レモンイエロー",color:"#fff33f",hint:"レモンの皮のような黄色",ex:"鮮やかな黄色の中でも、やや緑みを帯びた黄色"},
{name:"カーキ",color:"#8b864e",hint:"塵・埃を意味するペルシャ語に由来する色",ex:"イギリス軍の軍服の色として採用された、くすんだ黄みの緑色"},

{name:"オリーブ",color:"#808000",hint:"くすみ緑",ex:"実"},
